...
class TyphoonSelectDialog2: NSObject, UITableViewDelegate, UITableViewDataSource {
    ...
    init(index: Int, parentView: TyphoonViewController){
        ...
        switch index {
        case 1:
            items = ["■氾濫注意水位(水位4.5m)、水防警報(出動)", "■避難準備・高齢者等避難開始発令の見込み(1時間以内に水位5.4mに到達)", "■避難準備・高齢者等避難開始(水位5.4m)、避難勧告発令の見込み", "■避難勧告(水位5.5m)", "■避難指示(緊急)(水位8.3m)"] //淀川（枚方）
            break
        case 2:
            items = ["■氾濫注意水位(水位3.2m)、水防警報(出動)", "■避難準備・高齢者等避難開始発令の見込み(1時間以内に水位4.7mに到達)", "■避難準備・高齢者等避難開始(水位4.7m)、避難勧告発令の見込み", "■避難勧告(水位5.3m)", "■避難指示(緊急)(水位6.8m)"] //大和川（柏原）
            break
        case 3:
            items = ["■氾濫注意水位(水位3.8m)、水防警報(出動)", "■避難準備・高齢者等避難開始発令の見込み(1時間以内に水位4.8mに到達)", "■避難準備・高齢者等避難開始(水位4.8m)、避難勧告発令の見込み", "■避難勧告(水位5m)", "■避難指示(緊急)(水位5.8m)"] //神崎川（三国）
            break
        case 4:
            items = ["■氾濫注意水位(水位3.25m)、水防警報(出動)", "■避難準備・高齢者等避難開始発令の見込み(1時間以内に水位3.5mに到達)", "■避難準備・高齢者等避難開始(水位3.5m)、避難勧告発令の見込み", "■避難勧告(水位4.25m)", "■避難指示(緊急)(水位5.1m)"] //安威川（千歳橋）
            break
        case 5:
            items = ["■氾濫注意水位(水位3m)、水防警報(出動)", "■避難準備・高齢者等避難開始発令の見込み(1時間以内に水位3.1mに到達)", "■避難準備・高齢者等避難開始(水位3.1m)、避難勧告発令の見込み", "■避難勧告(水位3.3m)", "■避難指示(緊急)(水位3.5m)"] //寝屋川（京橋）
            break
        case 6:
            items = ["■氾濫注意水位(水位3.4m)、水防警報(出動)", "■避難準備・高齢者等避難開始発令の見込み(1時間以内に水位4.25mに到達)", "■避難準備・高齢者等避難開始(水位4.25m)、避難勧告発令の見込み", "■避難勧告(水位4.55m)", "■避難指示(緊急)(水位4.85m)"] //第二寝屋川（昭明橋）
            break
        case 7:
            items = ["■氾濫注意水位(水位3.3m)、水防警報(出動)", "■避難準備・高齢者等避難開始発令の見込み(1時間以内に水位3.9mに到達)", "■避難準備・高齢者等避難開始(水位3.9m)、避難勧告発令の見込み", "■避難勧告(水位4.15m)", "■避難指示(緊急)(水位4.4m)"] //平野川（剣橋）
            break
        case 8:
            items = ["■氾濫注意水位(水位3.3m)、水防警報(出動)", "■避難準備・高齢者等避難開始発令の見込み(1時間以内に水位3.4mに到達)", "■避難準備・高齢者等避難開始(水位3.4m)、避難勧告発令の見込み", "■避難勧告(水位3.85m)", "■避難指示(緊急)(水位4.63m)"] //平野川分水路（今里大橋）
            break
        case 9:
            items = ["■氾濫注意水位(水位3.2m)、水防警報(出動)"] //古川（桑才）
            break
        case 10:
            items = ["■氾濫注意水位(水位2.9m)、水防警報(出動)", "■避難準備・高齢者等避難開始発令の見込み(1時間以内に水位3.2mに到達)", "■避難準備・高齢者等避難開始(水位3.2m)、避難勧告発令の見込み", "■避難勧告(水位3.9m)", "■避難指示(緊急)(水位5.3m)"] //東除川（大堀上小橋）
            break
        case 11:
